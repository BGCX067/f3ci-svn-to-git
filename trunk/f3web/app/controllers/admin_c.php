...
class Admin_c extends CI_Controller {
	...
	public function __construct()
    {
		...
		$block_data['link_arr'][] = array('name'=>'admin'		,'href'=>base_url().'admin_c'		,'selected'=>'selected');
		...
		$block_data['link_arr'] = array(
							'index' => base_url().'admin_c/index',
							'login' => base_url().'admin_c/login');
	...
	{
		$this->data['title']= '後台管理(index)';

		$block_data['js_name'] = 'login.js';

		$this->data['block_head'] .= $this->load->view('/block/script_b.php',$block_data,true);
		$this->data['block_contents']= '';
